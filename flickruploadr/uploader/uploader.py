...
class Uploader(object):
    ...
    def __init__(self, obj):
        self.flickrcore = obj
        self.logger = common.create_logger('FlickrUploader')
        self.logger.info('Starting FlickrUploader')
        self.progress(msg1='Starting FlickrUploader')
        ...
        while True:
            try:
                ...
                if self._check_size(fname, file):
                    ...
                    self.progress(msg1='Uploading {}'.format(file))
                    ...
                    self.progress(msg2='Waiting for Flickr response...')
                ...
                if e == 'Error: 5: Filetype was not recognised' and retry is False:
                    self.progress(msg2='Retry upload of {}'.format(file))
                    ...
                    self.progress(msg2='Already retried upload of {}'.format(file))
